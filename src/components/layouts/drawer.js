...
import './drawer.css'
import JSCharts from'./JSCharts.js'
import { Statistic, Card, Row, Col , Timeline, Drawer, Progress, Button} from 'antd';
 ...
 // const isTabletOrMobile = useMediaQuery({ maxWidth: 1224 })
  ...
  return(
      ...
      {isTabletOrMobileDevice && 
        ...
        <Timeline.Item dot={<ClockCircleOutlined className="timeline-clock-icon" />}>Study Cost Accounting by: Wed. July 17th, 2020 </Timeline.Item>
      </Timeline>
